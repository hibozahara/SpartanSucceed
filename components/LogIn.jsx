...
export default function LogIn() {
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#567FED" }}>
      ...
      <TextInput placeholder="Username" placeholderTextColor='rgba(0,0,0,0.5)' style={styles.input}/>

      <TextInput placeholder="Password" placeholderTextColor='rgba(0,0,0,0.5)' style={styles.input}/>
